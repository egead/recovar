...
def phasenet_eqt_picks(stream):
    ...
    CATALOG_DATA = """03/11/2025 12:49:12,3.0,Sındırgı (Balıkesir)
03/11/2025 12:44:32,2.9,Sındırgı (Balıkesir)
03/11/2025 12:42:20,3.3,Sındırgı (Balıkesir)
03/11/2025 12:39:25,3.2,Sındırgı (Balıkesir)
03/11/2025 12:35:37,5.1,Sındırgı (Balıkesir)
03/11/2025 12:22:20,2.6,Sındırgı (Balıkesir)
03/11/2025 12:16:22,3.6,Sındırgı (Balıkesir)""".strip()
    ...
    csv_path = Path(f"/home/ege/recovar/reproducibility/phasenet_eqt/3NOVEMBER/3NOVEMBER_INSTANCE/KO_{station_name}_predictions.csv")
