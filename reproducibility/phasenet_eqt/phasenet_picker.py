...
def extract_windows_phasenet(stream, model_name='instance', threshold=0.7, phase='P', window_samples=4500):
    ...
    for peak_idx in peaks:
        ...
        stream_pick_sample = int((pick_time - stream_sync[0].stats.starttime) * stream_sync[0].stats.sampling_rate)
...
def save_windows(windows, pick_times, output_dir='phasenet_windows'):
    ...
    df.to_csv(os.path.join(output_dir, 'phasenet_picks_metadata.csv'), index=False)
